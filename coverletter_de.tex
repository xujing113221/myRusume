...
\newcommand{\companyname}{Google Inc.}
\newcommand{\companyaddress}{Helstorfel Str. 23}
\newcommand{\companylocal}{30625, Hannover}
...
\lettertitle{Bewerbung für die Praktikumsstelle als XXXXX (Nr. 798288)}
% How the letter is opened
\letteropening{Sehr geehrte Damen und Herren, (Sehr geehrter Herr Familienname oder sehr geehrte Frau Familienname)}
% How the letter is closed
\letterclosing{Mit freundlichen Grüßen}
% Any enclosures with the letter
\letterenclosure[i.A.]{Lebenslauf\\ Bescheinigungen\\ Überblick über meine technischen Innovationen\\ Immatrikulationsbescheinigung}
