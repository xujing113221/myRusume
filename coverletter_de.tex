...
%-------------------------------------------------------------------------------
\providecommand{\recname}{Company Recruitment Team}
\providecommand{\companyname}{Google Inc.}
\providecommand{\companyaddress}{Helstorfel Str. 23}
\providecommand{\companylocal}{30625, Hannover}
\providecommand{\applicatename}{Bewerbung für die Praktikumsstelle als XXXXX (Nr. 798288)}
